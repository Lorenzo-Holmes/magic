...
module.exports = Object.freeze([
  'index.html', 'src/style.css', 'src/data.js', 'src/engine.js', 'src/scenes.js', 'src/format.js', 'src/audio.js', 'src/presentation.js', 'src/meta.js', 'src/quantity.js', 'src/evolution.js', 'src/immortal.js', 'src/app.js', 'assets/seal.svg',
