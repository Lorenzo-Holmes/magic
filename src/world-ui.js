(function(root,factory){const api=factory(typeof module==='object'&&module.exports?require('./world.js'):root.FSWorld);if(typeof module==='object'&&module.exports)module.exports=api;else root.FSWorldUI=api;})(typeof globalThis!=='undefined'?globalThis:this,function(W){
  ...
  function view(s,button){
    ...
    return '<section class="creation-view world-phase-'+esc(s.phase)+'"><div class="creation-head"><span class="eyebrow">我即天道 · 第 '+esc(s.era)+' 纪</span><h2>'+esc(W.name(s))+'</h2><p>你曾仰望的天地，如今正从掌心生长。</p></div><div class="world-vitals"><div><span>天地生机</span><b>'+s.vitality+' <small>/ 100</small></b><meter min="0" max="100" value="'+s.vitality+'" aria-label="天地生机"></meter></div><div><span>众生秩序</span><b>'+s.order+' <small>/ 100</small></b><meter min="0" max="100" value="'+s.order+'" aria-label="众生秩序"></meter></div></div>'+ 
